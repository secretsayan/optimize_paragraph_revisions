 ...
 */
class OptimizeParagraphRevisionCompositeUpdateTestsWithContentModeration extends EntityKernelTestBase {
   ...
   */
  public function testNoRevisionsCreatedForUnChangedParagraphsOnHostChangesWithContentModeration(): void {
  ...
  public function testNewRevisionsCreatedForChangedParagraphsOnlyWithContentModeration(): void {
    // Create the paragraph type.
    $paragraph_type = ParagraphsType::create([
      'label' => 'test_text',
      'id' => 'test_text',
  ...
  public function testRevisionCreationWhenSetNewRevisionIsFalseInHostAndChangedParagraphIsReferencedBySingleOrMultipleHostRevisionWithContentModeration(): void {
    // Create the paragraph type.
    $paragraph_type = ParagraphsType::create([
      'label' => 'test_text',
      'id' => 'test_text',
  ...
  public function testNoRevisionsCreatedWhenSetNewRevisionIsFalseInHostAndParagraphsDoNotChangeWithContentModeration(): void {
    // Create the paragraph type.
    $paragraph_type = ParagraphsType::create([
      'label' => 'test_text',
      'id' => 'test_text',
